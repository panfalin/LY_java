...
/**
 * 清仓库存对象 aliexpress_sku_analysis_clearance
 * 
 * @author ruoyi
 * @date 2025-02-11
 */
public class AliexpressSkuAnalysisClearance extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("stockImageUrl", getStockImageUrl())
            .append("totalStock", getTotalStock())
            .append("localInTransitQuantity", getLocalInTransitQuantity())
            .append("localAvailableQuantity", getLocalAvailableQuantity())
            .append("backupInTransitQuantity", getBackupInTransitQuantity())
            .append("halfManagementBackupAvailableQuantity", getHalfManagementBackupAvailableQuantity())
            .append("fullManagementBackupAvailableQuantity", getFullManagementBackupAvailableQuantity())
            .append("warehouseCost", getWarehouseCost())
            .append("totalWarehouseCost", getTotalWarehouseCost())
            .append("salesLast7Days", getSalesLast7Days())
            .append("salesLast28Days", getSalesLast28Days())
            .append("salesLast42Days", getSalesLast42Days())
