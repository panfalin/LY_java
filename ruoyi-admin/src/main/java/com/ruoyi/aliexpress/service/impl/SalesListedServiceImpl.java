...
import com.ruoyi.aliexpress.mapper.SalesListedMapper;
 ...
 */
@Service
public class SalesListedServiceImpl implements ISalesListedService
{
    @Autowired
    private SalesListedMapper salesServiceMapper;
    ...
    {
        return salesServiceMapper.selectDailyTaskById(id);
    }
    ...
    public List<DailyTask> selectDailyTaskList(DailyTask dailyTask)
    {
        ...
        return salesServiceMapper.selectDailyTaskList(dailyTask);
    }
    ...
    {
        return salesServiceMapper.insertDailyTask(dailyTask);
    }
    ...
    public int updateDailyTask(DailyTask dailyTask)
    {
        ...
        return salesServiceMapper.updateDailyTask(dailyTask);
    }
...
//        sendto.put("未分配","857240603@qq.com");
        ...
        try{
           ...
           // 查询所有未分配的任务
           List<DailyTask> allTasks = salesServiceMapper.selectDailyTaskUnfinishedList();
           ...
           int totalUpdatedTasks = 0;
            ...
            for (Map.Entry<String, List<DailyTask>> entry : tasksByResponsiblePerson.entrySet()) {
               ...
               // 更新任务的任务时间和责任人
               int updatedCount = salesServiceMapper.updateDailyTaskUnfinished(params);
               // 累计更新的任务数量
    ...
    {
        return salesServiceMapper.deleteDailyTaskByIds(ids);
    }
    ...
    {
        return salesServiceMapper.deleteDailyTaskById(id);
    }
}
